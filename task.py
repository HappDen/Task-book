...
age = input()
nickname = input()
print("Hi coders! I want to join your community! My name is" ,name, surname + "!" " My native language is " , language + "!" " And I'm proud of it! I was born", age + "." " Not bad, right? You can contact me like", nickname + "." " I think we will make friends :) And I wish you a great time on our planet.") 